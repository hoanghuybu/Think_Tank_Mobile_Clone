...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native Think_Tank initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this think_tank : https://thecodingmachine.github.io/react-native-think_tank/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-think_tank/issues'
			);
			console.log(
				'- ⭐ If you love this think_tank, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-think_tank'
			);
